    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li >Home</li>
                    <li class=active ><a href="adminResidents.html">Analytics</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <nav class="navbar-default sidebar" role="navigation">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="adminAnalytics.html" class="list-group-item active">Analytics</a>
                    ...
                    <li class="dropdown list-unstyled">
                        <a href="adminResidents.html" class="list-group-item dropdown-toggle" data-toggle="dropdown">Residents <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Graph 1</a>
                </h3>
            ...
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Graph 2</a>
                </h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Graph 3</a>
                </h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Graph 4</a>
                </h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
        </div>
