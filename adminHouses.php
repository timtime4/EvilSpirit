    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li >Home</li>
                    <li class=active ><a href="adminResidents.html">Houses</a>
                    </li>
                </ol>
            </div>
        </div>
         ...
         <nav class="navbar-default sidebar" role="navigation">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <li class="dropdown list-unstyled">
                        <a href="adminHouses.html" class="list-group-item dropdown-toggle active" data-toggle="dropdown">Houses <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
